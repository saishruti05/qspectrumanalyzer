...
from utils import str_to_color, human_time

from settings import QSpectrumAnalyzerSettings
from smoothing import QSpectrumAnalyzerSmoothing
from persistence import QSpectrumAnalyzerPersistence
from colors import QSpectrumAnalyzerColors
from baseline import QSpectrumAnalyzerBaseline
...
class QSpectrumAnalyzerMainWindow(QtWidgets.QMainWindow, Ui_QSpectrumAnalyzerMainWindow):
    ...
    def setup_power_thread(self):
        ...
        backend_module = soapy_power

        if self.backend is None:
            self.backend = 'soapy_power'
